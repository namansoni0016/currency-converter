...
function App() {
  ...
  const currencyCodes = ["USD", "EUR", "GBP", "INR", "JPY", "CAD", "BSD"];
  ...
  return (
    <div>
      <section className='hero'>
        ...
        <p>Your go-to solution for reat-time currency conversions worldwide!</p>
      </section>
      <section className='converter'>
        <form onSubmit={handleSubmit}>
          <select name="from" value={formData.form} onChange={handleChange} className='input'>
          ...
          <input type="number" name='amount' value={formData.amount} onChange={handleChange} placeholder='Amount' className='input' />
